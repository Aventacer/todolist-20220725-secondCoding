package com.jaewon.todolist.service.todo;
...
import com.jaewon.todolist.domain.todo.Todo;
import com.jaewon.todolist.domain.todo.TodoRepository;
...
//		return true;
	...
	/*
	 * @Override public List<TodoListRespDto> getImportanceTodoList(int page, int
	 * contentCount) throws Exception {
	 * 
	 * List<Todo> todoList =
	 * todoRepository.getImportanceTodoListOfIndex(createGetTodoListMap(page,
	 * contentCount));
	 * 
	 * return createTodoListRespDtos(todoList); }
	 */
	...
	private Map<String, Object> createGetTodoListMap(String type, int page, int contentCount) {
		...
		map.put("type", type);
		map.put("index", (page - 1) * contentCount); // if(page ==1 && contentCount == 10) -> 0 * 10
